...
const AddWaterModal = ({ setIsOpen, onClick }) => {
    ...
    <div className={module.modal}>
      <div className={module.container}>
        ...
        <div className={module.submitDiv}>
          <p className={module.answer}>
            {amountWater}
            <span>ml</span>
          </p>
          <button className={module.submitBtn} onClick={handleSubmit}>
            Save
          </button>
        </div>
      </div>
